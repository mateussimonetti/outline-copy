...
export const deleteCommentFactory = ({ comment, onDelete } : { comment: Comment; onDelete: () => void }) => {
    createAction({
        name: ({ t }) => `${t("Delete")}...`,
...
export const resolveCommentFactory = ({ comment, onResolve} : { comment: Comment; onResolve: () => void}) => {
    createAction({
...
export const unresolveCommentFactory = ({ comment, onUnresolve } : { comment: Comment; onUnresolve: () => void }) => {
    createAction({
...
export const viewCommentReactionsFactory = ({ comment } : { comment: Comment }) => {
    createAction({
        name: ({ t }) => `${t("View reactions")}`,
        analyticsName: "View reactions",
        section: DocumentSection,
        icon: <SmileyIcon />,
        visible: () => 
